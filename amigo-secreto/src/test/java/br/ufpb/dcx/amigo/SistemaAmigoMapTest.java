...
public class SistemaAmigoMapTest {
    ...
    void testSistemaAmigoMap() {
        ...
        Assertions.assertThrows(AmigoInexistenteException.class, ()-> sistema.pesquisaAmigo("ayla@teste.com"));
    }
    ...
    void testPesquisaECadastraAmigo() {
        ...
        try {
            ...
            Amigo amigo = sistema.pesquisaAmigo("ayla@teste.com");
            Assertions.assertEquals("ayla", amigo.getNome());
            Assertions.assertEquals("ayla@teste.com", amigo.getEmail());
